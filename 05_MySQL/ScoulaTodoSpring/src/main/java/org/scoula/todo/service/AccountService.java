...
//    UserDao dao = new UserDaoImpl();
    ...
    public void join() {
        try {
            UserVO user = getUser();
            dao.create(user);
        } catch (UsernameDuplicateException | PasswordMismatchException e) {
    ...
    private UserVO getUser() throws SQLException, UsernameDuplicateException, PasswordMismatchException {
