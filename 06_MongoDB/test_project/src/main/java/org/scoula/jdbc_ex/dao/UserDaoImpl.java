...
public class UserDaoImpl implements UserDao {
    ...
    String update = "update user set name = ?, password = ? where id = ?";
    ...
    @Override
    public Optional<UserVO> findById(String id) throws SQLException {
    ...
    public List<UserVO> findAll() throws SQLException {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(findAll);
